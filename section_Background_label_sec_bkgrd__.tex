...
\section{Project and Timeline}\label{sec:project}
    ...
    As of Spring 2016, the CARMA observations have been completed and the data reduced. The NRO observations are ongoing. NRO has covered approximately 70\% of the CARMA coverage in $^{12}$CO and $^{13}$CO
