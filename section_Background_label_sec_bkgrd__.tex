...
Protostars add mass from an accretion disk which in turn is fed by infall from a surrounding envelope of dense gas. As a protostar evolves this disk grows and the envelope disappears. The accretion disk powers a strong wind which triggers bipolar outflows of molecular gas around the protostar. 
